function wakeUp() {
	...
	function alertUser() {
		...
		if (snowflake_check != "<iframe class=\"border border-success rounded\" src=\"https://snowflake.torproject.org/embed.html\" width=\"320\" height=\"260\" frameborder=\"0\" scrolling=\"no\"></iframe>") {
...
function ls() {
	...
	if (pwd == "<small onclick=\"alert(hint)\" style=\"color: #149414;\">⁓/</small>") {
		...
		document.getElementById("stdout").innerHTML = "<pre><code style=\"color: #149414;\">github.md    dbmonster.md    chow.md    bettersniff.md</code><pre>";
	}
